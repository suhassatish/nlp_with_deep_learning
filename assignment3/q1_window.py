...
class Config:
    ...
    """
    n_word_features = 2 # Number of features for every word in the input. This is D
    window_size = 1 # The size of the window to use. w
    ### YOUR CODE HERE
    n_window_features = (2 * window_size + 1) * n_word_features # The total number of features used for each window. This is e(t) = 1 x (2w+1)D
    ### END YOUR CODE
    n_classes = 5
    dropout = 0.5
    embed_size = 50
